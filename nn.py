...
def create_mlp(input_shape, hidden_layers, output_shape):
    ...
    model = Sequential()
    model.add(Dense(hidden_layers[0], kernel_initializer='uniform', activation='relu', input_shape=(input_shape,)))
    ...
    model.name = str(input_shape) + "-" + str(hidden_layers) + "-" + str(output_shape)
